define("jquery/highcharts/3.0.4/exporting-debug", [], function(require, exports, module) {
    /**
 ...
 */
	 ...
	 */
            getSVG: function(additionalOptions) {
                var chart = this, chartCopy, sandbox, svg, seriesOptions, sourceWidth, sourceHeight, cssWidth, cssHeight, options = merge(chart.options, additionalOptions);
	 ...
	 */
            contextMenu: function(name, items, x, y, width, height, button) {
                var chart = this, navOptions = chart.options.navigation, menuItemStyle = navOptions.menuItemStyle, chartWidth = chart.chartWidth, chartHeight = chart.chartHeight, cacheName = "cache-" + name, menu = chart[cacheName], menuPadding = mathMax(width, height), // for mouse leave detection
                boxShadow = "3px 3px 10px #888", innerMenu, hide, hideTimer, menuStyle;
	 ...
	 */
            addButton: function(options) {
                ...
                }, symbolSize = btnOptions.symbolSize || 12, menuKey;
                if (!chart.btnCount) {
                    chart.btnCount = 0;
                }
                ...
                if (onclick) {
                    ...
                    callback = function() {
                        chart.contextMenu("contextmenu", menuItems, button.translateX, button.translateY, button.width, button.height, button);
                        button.setState(2);
                    };
                }
                ...
                if (btnOptions.symbol) {
                    symbol = renderer.symbol(btnOptions.symbol, btnOptions.symbolX - symbolSize / 2, btnOptions.symbolY - symbolSize / 2, symbolSize, symbolSize).attr(extend(symbolAttr, {
